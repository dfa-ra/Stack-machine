...
- **Тип**: `строка`
- **Ограничения**:
  - Должно быть уникальным в наборе конфигураций
  - Только буквы, цифры и подчёркивание
  - Максимальная длина: 32 символа

`limit`
- **Тип**: `целое беззнаковое 32-битное`
- **Ограничения**:
  - Минимум: 1
  - Максимум: 1 000 000
  - По умолчанию: 5 000
...
`memory_size`
- **Тип**: `целое беззнаковое 32-битное` (в байтах)
- **Ограничения**:
  - Минимум: 100
  - Максимум: 10 000
...
- **Тип элемента**: `int32`
- **Ограничения массива**:
  - Максимальная длина: memory_size/4
  - Пустой массив разрешён

### 3. Спецификация отчётов

 - Свойство `name` - азвание типа отчёта 
...
- Свойство `view` - то что будет отобрадаться в отчёте
